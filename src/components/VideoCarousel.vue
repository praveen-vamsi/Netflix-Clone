        ...
        >
            ...
            >
                <div 
                    ...
                    :class="
                        currentSlide !== index ? 'border-4 border-transparent transform scale-2 translate-y-5' : 'border-4 border-white rounded-xl transition-transform ease-in-out duration-300',
                        currentSlideObject(slide, index)
                    "
                >
                    <img 
                        style="user-select: none" 
                        class="pointer-events-none h-[100%] z-[-1] rounded-lg" 
